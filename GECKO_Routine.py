...
# - Update: Gregory S.H. Paek (23.06.07)
...
# path = "/data6/obsdata/LSGT_ASI1600MM/gwtest"
tdict = dict()
starttime = time.time()
...
for obj in objlist:
	for filte in filterlist:
		for tail in tails:
			...
			# if project == 'GECKO':
			pathto = f'{path_gw}/{obs}/{filte}'
			files = f'{path_data}/*Calib*-{filte}-*{tail}*'
